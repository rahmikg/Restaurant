    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> SummaryPost(string stripeEmail, string stripeToken)
        {
            ...
            if (charge.Status.ToLower() == "succeeded")
            {
                ...
                await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == claim.Value).FirstOrDefault().Email, "Restaurant - Order Created " + detailCart.OrderHeader.Id.ToString(), "Order has been submitted successfully." ); 
