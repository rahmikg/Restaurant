...
namespace Restaurant.Areas.Customer.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        public async Task<IActionResult> OrderPrepare(int OrderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Restaurant - Order is being pepared " + orderHeader.Id.ToString(), "Order is getting ready for pickup.");
        ...
        public async Task<IActionResult> OrderReady(int OrderId)
        {
            ...
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Restaurant - Order Ready for Pickup " + orderHeader.Id.ToString(), "Order is ready for pickup.");
        ...
        public async Task<IActionResult> OrderCancel(int OrderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Restaurant - Order Cancelled " + orderHeader.Id.ToString(), "Order has been cancelled successfully.");
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            await _db.SaveChangesAsync();
            await _emailSender.SendEmailAsync(_db.Users.Where(u => u.Id == orderHeader.UserId).FirstOrDefault().Email, "Restaurant - Order Completed " + orderHeader.Id.ToString(), "Order has been completed successfully." );
